...
import { addToCartIcon } from '../initializers/my-icons.js';

class MyVehicles extends connect(store)(PageViewElement) {
...
window.customElements.define('my-vehicles', MyVehicles);